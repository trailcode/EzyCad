...
| Sketch subsystem (`src/sketch*`, `src/skt_*`, `tests/sketch_*_tests.cpp`, sketch behavior in `occt_view` / `gui`) | [src/doc/sketch.md](../../src/doc/sketch.md) — read before editing; update when API, invariants, module layout, or workflows change            |
...
| Module doc                                     | When                                                                                                                      |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| [src/doc/sketch.md](../../src/doc/sketch.md)   | Editing `src/sketch*`, `src/skt_*`, `tests/sketch_*_tests.cpp`, or sketch-facing behavior in `occt_view` / `gui` / `mode` |
