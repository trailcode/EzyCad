...
- `CHANGELOG.md`
- `agents/drafts/issues/active/gh-NNN-....md` (or `agents/drafts/prs/active/gh-NNN-....md`)
- ...
...
- Other drafts: `agents/drafts/issues/...`
...
- [ ] (If user-visible) cross-check [agents/conventions/user-docs-sync.md](../../conventions/user-docs-sync.md).
...
- [ ] Move drafts to `archive/` when done.
