...
- Graphical Debugging: `to_boost_ls`, `segment_2d` / `ring_2d` as Ring, `scripts/ezycad_graphical_debugging.xml` (https://github.com/awulkiew/graphical-debugging).
...
- [ ] Optional: Geometry Watch with `scripts/ezycad_graphical_debugging.xml`
