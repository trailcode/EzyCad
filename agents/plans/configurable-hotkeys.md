...
- Toolbar tooltips for remappable modes follow the binding table.
...
**Out of v1:** polar dup / cross-section / sketch-tool letters; custom multi-chord sequences; per-mode binding contexts; WASM #93 parity.
