...
| `default_2d_view_width`       | number             | Horizontal sketch-plane span (**inches** in settings; independent of project units) for **File -> New** / projects with no saved camera (allowed range **0.1** to **1000**; default **3**). |
| `default_2d_view_height`      | number             | Vertical sketch-plane span (**inches** in settings) for the same framing (allowed range **0.1** to **1000**; default **3**).                                                                  |
