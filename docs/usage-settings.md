...
For other non-sketch Options content, see the matching tool section in the usage guide. In particular, **Shape cross-section** provides local **XY/XZ/YZ**, **Offset**, **Update preview**, and **Clear** controls; see [Shape cross-section tool](usage.md#shape-cross-section-tool).
