...
- Project I/O (`.ezy` load/save, import/export dialogs; **File -> Import** shows metadata then loads STEP/PLY; STEP **Import as** chooses preserve hierarchy / flat solids / union).
