...
| `shp_cyl_align.h`     | `Shp_cyl_align`        | Pick two cylindrical faces (first moves); map cylinder axes through AIS `LocalTransformation` (Workbench instance pose; identity on Design); coaxial `cyl_align_trsf`; drag axial depth; Options **Clock rotation** (default off) then LMB / Shift+Tab about shared axis; Options flip; bake like Move.                                                                                                                                                                                                                                                                                                                                  |
