...
| `shp_cyl_align.h`     | `Shp_cyl_align`        | Pick two cylindrical faces (first moves); coaxial `cyl_align_trsf`; drag axial depth; LMB enters twist about shared axis; Options flip; bake like Move.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `Mode::Shape_cyl_align`       | `drag_depth` / `drag_twist`      | Pick faces; LMB depth->twist; LMB/Enter finalize                                                                  | Tab depth or twist angle; Enter finalize (skips twist)                 | `shp_cyl_align().cancel` -> `Normal`   |
...
| `utl_geom.h`                        | Plane projection, bbox center, `cylinder_from_face` / `cyl_align_trsf` (coaxial + twist), rotation helpers |
