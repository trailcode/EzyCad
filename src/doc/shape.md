...
| `shp_rotate.h`        | `Shp_rotate`           | Rotate about view axis or Local/World X/Y/Z through the current pivot; angle Tab entry; axis/center AIS guides (Topmost). Axis can be set before the first drag.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
