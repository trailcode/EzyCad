...
| Analysis          | `to_boost` (polygon), `to_boost_ls` (edge `linestring_2d`), `get_shape_bbox_center`, `plane_from_face`, `side_of_plane`, `same_line_support_2d`, `collinear_overlap_cut_points_2d`, `same_circle_support_2d`                                                                        |
