...
std::string GUI::get_doc_url_for_mode(Mode mode)
{
  static const std::unordered_map<Mode, std::string> doc_urls = {
      ...
      {Mode::Shape_chamfer,                   "https://ezycad.readthedocs.io/en/latest/usage.html#chamfer-tool-c"},
      {Mode::Shape_fillet,                    "https://ezycad.readthedocs.io/en/latest/usage.html#fillet-tool-f"},
...
void GUI::options_sketch_shared_controls_()
{
  ...
  if (ImGui::BeginTable("options_sketch_sketch", 2, k_options_table_flags))
  {
    ...
    const bool snap_enabled = Sketch_nodes::get_snap_guide_mode() != Sketch_nodes::Snap_guide_mode::None;
    if (snap_enabled)
    {
      ImGui::TableNextRow();
      ImGui::TableSetColumnIndex(0);
