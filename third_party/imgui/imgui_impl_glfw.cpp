...
#ifdef EMSCRIPTEN_USE_EMBEDDED_GLFW3
// Emscripten HiDPI: match canvas backing-store to CSS * devicePixelRatio so text is not
// upscaled/blurred by the browser. See https://github.com/ocornut/imgui/issues/7519#issuecomment-2629628233
static EM_BOOL ImGui_ImplGlfw_OnCanvasSizeChange(int event_type, const EmscriptenUiEvent* event, void* user_data)
{
    ...
    int    new_width  = (int)(css_width * dpr);
    int    new_height = (int)(css_height * dpr);
